...
optimizer = torch.optim.Adagrad(model.parameters(), lr=15e-2)
...
checkpoint = {"epochs_trained": epochs, "optimizer": optimizer.state_dict(),
              "model": model.state_dict()}

model_save_path = "model-checkpoint-1.pt"
